...
import com.centreon.map.config.audit.AuditEventConverter;
import com.centreon.map.domain.PersistentAuditEvent;
...
import static com.centreon.map.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
